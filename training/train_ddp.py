        ...
        if rank == 0:
            ...
            if val_acc > best_acc:
                ...
                save_checkpoint(model, optimizer, scheduler, epoch, best_acc, 
                              args.save_path, train_dataset.class_names, config, history)
...
def main():
    ...
    parser.add_argument('--save-path', type=str, default='models/genconvit_ddp_improved.pth',
                       help='Path to save the best model (default: models/genconvit_ddp_improved.pth)')
